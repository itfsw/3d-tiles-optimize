 ...
 * Version.
 */
const json = JSON.parse(readFileSync(new URL('../package.json', import.meta.url), {encoding: 'utf-8'}));
program.version(json.version || '0.0.0').description('Optimize 3d-tiles by 3d-tiles-tools with glTF-Transform.');
